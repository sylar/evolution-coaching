(function() {
  ...
  $('#navbar .menu .switch').on('langchange', function(e) {
    return console.log(e);
  });

  $('#navbar .menu .switch').trigger('lang::change');

  $('#navbar .menu .switch').click(function() {
    console.log('click');
    if (language === 'en') {
    ...
    return document.querySelector('#navbar .menu .switch').dispatchEvent(new Event('langchange'));
  });
